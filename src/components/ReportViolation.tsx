    ...
    <div className="space-y-6">
      ...
      <AnimatePresence mode="wait">
        {step === 'capture' && (
          ...
          >
            <div className="w-32 h-32 bg-red-100 text-red-600 rounded-full flex items-center justify-center relative">
              <div className="absolute inset-0 bg-red-400/20 rounded-full animate-ping" />
              <Camera className="w-16 h-16 relative z-10" />
            </div>
            
            <div className="text-center space-y-2">
              <h3 className="text-xl font-black tracking-tight uppercase">Upload Bukti</h3>
            ...
            <div className="w-full grid grid-cols-2 gap-3 pt-10">
              ...
              <Button 
                ...
                className="h-20 rounded-3xl bg-red-600 hover:bg-red-700 text-sm font-black flex flex-col gap-1 shadow-xl shadow-red-200 uppercase tracking-widest"
              >
              ...
              <Button 
                onClick={() => document.getElementById('report-media')?.click()} 
                variant="outline" 
                className="h-20 rounded-3xl border-2 border-red-100 text-red-600 hover:bg-red-50 text-sm font-black flex flex-col gap-1 uppercase tracking-widest"
              >
        ...
        {step === 'details' && (
          <motion.div 
            ...
            className="space-y-6"
          >
            <div className="aspect-video rounded-3xl overflow-hidden bg-slate-200 relative border-4 border-white shadow-xl">
              {mediaType === 'image' ? (
              ...
              <CardContent className="p-6 space-y-5">
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Lokasi Kejadian</Label>
                    <div className="relative">
                      ...
                      <Input 
                        ...
                        className="h-12 pl-10 rounded-2xl bg-slate-50 border-none font-bold focus-visible:ring-emerald-500"
                      />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Keterangan / Orang Mencurigakan</Label>
                    <div className="relative">
                      <UserSearch className="absolute left-4 top-4 w-4 h-4 text-emerald-600" />
                      <Textarea 
                        placeholder="Ciri-ciri pelaku atau detail sampah..." 
                        value={evidenceDesc}
                        onChange={(e) => setEvidenceDesc(e.target.value)}
                        className="min-h-[100px] pl-10 pt-3 rounded-2xl bg-slate-50 border-none font-bold focus-visible:ring-emerald-500"
                      />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400 ml-1">Kategori Laporan</Label>
                    <div className="grid grid-cols-2 gap-2 mt-1">
                      <Button 
                        ...
                        className={cn(
                          ...
                          category === 'Sampah Liar' ? "bg-red-600" : "border-slate-200 bg-slate-50 text-slate-400"
                        )}
                      >
                        Sampah Liar
                      </Button>
                      <Button 
                        ...
                        className={cn(
                          "h-10 text-[10px] rounded-xl font-black uppercase tracking-widest",
                          category === 'Pembakaran' ? "bg-red-600" : "border-slate-200 bg-slate-50 text-slate-400"
                        )}
                      >
                        Pembakaran
                      </Button>
                ...
                <Button 
                  ...
                  className="w-full h-14 rounded-2xl bg-slate-900 hover:bg-black shadow-lg shadow-slate-100 uppercase font-black tracking-widest"
                >
        ...
        {step === 'success' && (
          ...
          >
            ...
            <div className="space-y-2">
              <h3 className="text-3xl font-black tracking-tighter uppercase italic text-emerald-600">LAPORAN DITERIMA</h3>
              ...
              <div className="pt-4 flex items-center justify-center gap-2">
                ...
                <p className="text-xs font-bold text-slate-500 text-left leading-tight uppercase">POIN <br/>INSENTIF</p>
              </div>
            </div>
